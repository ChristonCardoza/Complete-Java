...
public class SlackRoom {
    ...
    private final Sinks.Many<SlackMessages> sink;
    private final Flux<SlackMessages> flux;
    ...
    public void addMembers(SlackMember slackMember){
    ...
    private void postMessage(String sender, String message){
        this.sink.tryEmitNext(new SlackMessages(sender, message));
    }
}
